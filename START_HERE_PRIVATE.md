# 🚀 DÉMARRAGE RAPIDE - Dashboard Linux pour rmm.selest.info

> **Bienvenue ! Ce guide vous aidera à installer l'interface de déploiement d'agents Linux sur votre serveur Tactical RMM.**

## 🎯 Qu'est-ce que c'est ?

Cette intégration ajoute à votre dashboard Tactical RMM (**rmm.selest.info**) la possibilité de :
...
Ouvrez : **https://api.rmm.selest.info/admin/**
...
└─────────────────────────────────────────────────────────────┘
                            ...
                            ▼
┌─────────────────────────────────────────────────────────────┐
│     https://api.rmm.selest.info/clients/{UUID}/deploy/...  │
│                                                             │
...
curl -H "Authorization: Token VOTRE_TOKEN" \
  https://api.rmm.selest.info/api/v3/linux-deployments/
...
curl -X POST \
  ...
  https://api.rmm.selest.info/api/v3/linux-deployments/create/

# Voir les stats
curl -H "Authorization: Token VOTRE_TOKEN" \
  https://api.rmm.selest.info/api/v3/linux-deployments/stats/
```
