...
class LinuxDeploymentAdmin(admin.ModelAdmin):
    ...
    def install_command_display(self, obj):
...
# Action personnalisée pour prolonger l'expiration
...
# Ajouter l'action au admin
LinuxDeploymentAdmin.actions = [extend_expiration]
