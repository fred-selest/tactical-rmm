# Tactical RMM - Documentation Index

Point d'entree principal de la documentation du projet.

> **Note :** Les fichiers originaux restent a leur emplacement d'origine pour ne pas casser les liens git. Ce fichier sert de reference centralisee.
...
- [scripts/eset/README.md](../scripts/eset/README.md) - Scripts ESET
- [scripts/linux/auto-update/README.md](../scripts/linux/auto-update/README.md) - Scripts auto-update Linux
- [scripts/omada/README.md](../scripts/omada/README.md) - Scripts Omada
- [scripts/plesk/README.md](../scripts/plesk/README.md) - Scripts Plesk
- [scripts/synology/README.md](../scripts/synology/README.md) - Scripts Synology
- [scripts/veeam/README.md](../scripts/veeam/README.md) - Scripts Veeam
- [scripts/windows/README.md](../scripts/windows/README.md) - Scripts Windows
- [scripts/windows/install/README.md](../scripts/windows/install/README.md) - Scripts d'installation Windows

## Integration

- [integration/README.md](../integration/README.md) - Documentation integration
- [integration/docs/INTEGRATION_GUIDE.md](../integration/docs/INTEGRATION_GUIDE.md) - Guide d'integration
- [integration/backend/README.md](../integration/backend/README.md) - Backend integration
- [integration/backend/migrations/README.md](../integration/backend/migrations/README.md) - Migrations
- [integration/frontend/README.md](../integration/frontend/README.md) - Frontend integration
- [DASHBOARD_INTEGRATION_README.md](../DASHBOARD_INTEGRATION_README.md) - Integration dashboard
