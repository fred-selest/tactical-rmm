...
echo "  • GET    https://api.rmm.votre-domaine.com/api/v3/linux-deployments/"
echo "  • POST   https://api.rmm.votre-domaine.com/api/v3/linux-deployments/create/"
echo "  • GET    https://api.rmm.votre-domaine.com/api/v3/linux-deployments/{uuid}/"
echo "  • DELETE https://api.rmm.votre-domaine.com/api/v3/linux-deployments/{uuid}/"
echo "  • GET    https://api.rmm.votre-domaine.com/api/v3/linux-deployments/stats/"
echo ""
echo -e "${CYAN}Endpoint public (sans authentification) :${NC}"
echo "  • GET    https://api.rmm.votre-domaine.com/clients/{uuid}/deploy/linux/"
echo ""

print_header "🧪 Tests de vérification"

echo -e "${YELLOW}Test 1 : Vérifier que l'API répond${NC}"
echo "  curl -I https://api.rmm.votre-domaine.com/api/v3/linux-deployments/"
...
echo "     ${GREEN}https://api.rmm.votre-domaine.com/admin/${NC}"
echo ""
...
echo -e "${GREEN}${BOLD}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  🎊 Bon déploiement avec rmm.votre-domaine.com ! 🎊"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "${NC}"
